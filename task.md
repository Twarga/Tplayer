...
- [x] **T49** — Handle edge cases (no FFmpeg, no yt-dlp, empty library, corrupt files, DB errors)
- [x] **T50** — Add loading & empty states (skeletons, illustrations, CTAs for all views)
