...
import { Home, Library, Music, Disc, Users, ListMusic, Folder, Youtube, Compass, Heart, Settings, ChevronDown, Plus } from 'lucide-react'
  ...
  return (
    <aside className="w-[200px] min-w-[200px] h-full bg-sidebar-bg border-r border-border-subtle flex flex-col">
      ...
      <nav className="flex flex-col gap-1 px-2">
        ...
        <NavItem
          icon={<span className="text-red-500"><Youtube size={20} /></span>}
