...
export function YouTubeView() {
  const { searchResults, isSearching, downloads, search, download, init } = useYouTubeStore()
  ...
  const handleDownload = async () => {
    ...
    if (videoId) {
      await download(urlInput, videoId)
      setUrlInput('')
    }
  }
  ...
  return (
    <div className="p-6 overflow-y-auto h-full">
      ...
      {downloads.length > 0 && (
        <div>
          <h2 className="text-lg font-semibold text-primary mb-4">Downloads</h2>
